...
def student(sid):
    ...
    if session.get('user_id') is not None:
        ...
        return render_template('student.html', basic_info)
    else:
...
def student_edit(sid):
    ...
    return render_template('edit_stu.html', basic_info)
...
def course_check(sid):
    ...
    results_major = fetch_stu_course(sid)
    results_non_major = fetch_stu_course(sid, False)
    return render_template('course_check.html', results_major, results_non_major)
